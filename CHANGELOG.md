...
- Geometric mouse Sensitivity curve (issues #275, #306): the slider follows `3 ^ ((pct - 50) / 50)` - 50% = neutral 1.0x (saved settings unchanged), 0% drops to ~0.33x for fine aim, 100% reaches 3.0x for fast flicks - scaling both the reticle speed and the edge-pan rate.
