...
- F3 debug second row: live game-state internals (enemies alive/total, in-flight bolts/tracers/blood FX, kills, level, active weapon + fire/reload timers, stamina, heat, held keys, door lock) plus a player speed readout, so you can see what the simulation is doing.
