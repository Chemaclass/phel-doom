...
**Distance fade**: `t = min(0.85, (dist/max-depth)²)`. RGB cube (16-231) scaled (1-t); grayscale (232-255) pulled to 232. Squared curve: close vivid, mid-range fade, 0.85 cap for silhouette.
